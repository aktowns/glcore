 ...
 * }
 */
public class PFNGLVERTEXATTRIB4IVARBPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLVERTEXATTRIB4IVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIB4IVARBPROC.Function fi, Arena arena) {
