 ...
 * }
 */
public class PFNGLCOMPRESSEDTEXIMAGE2DPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLCOMPRESSEDTEXIMAGE2DPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLCOMPRESSEDTEXIMAGE2DPROC.Function fi, Arena arena) {
