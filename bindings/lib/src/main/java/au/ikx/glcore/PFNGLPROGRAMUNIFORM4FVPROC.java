 ...
 * }
 */
public class PFNGLPROGRAMUNIFORM4FVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLPROGRAMUNIFORM4FVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORM4FVPROC.Function fi, Arena arena) {
