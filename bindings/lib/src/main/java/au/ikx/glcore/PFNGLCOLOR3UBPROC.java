 ...
 * }
 */
public class PFNGLCOLOR3UBPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLCOLOR3UBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLCOLOR3UBPROC.Function fi, Arena arena) {
