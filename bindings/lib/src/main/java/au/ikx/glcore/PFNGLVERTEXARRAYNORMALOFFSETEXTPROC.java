 ...
 * }
 */
public class PFNGLVERTEXARRAYNORMALOFFSETEXTPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLVERTEXARRAYNORMALOFFSETEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXARRAYNORMALOFFSETEXTPROC.Function fi, Arena arena) {
