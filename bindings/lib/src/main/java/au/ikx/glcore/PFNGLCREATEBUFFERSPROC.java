 ...
 * }
 */
public class PFNGLCREATEBUFFERSPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLCREATEBUFFERSPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLCREATEBUFFERSPROC.Function fi, Arena arena) {
