 ...
 * }
 */
public class PFNGLTEXCOORD4IPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLTEXCOORD4IPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLTEXCOORD4IPROC.Function fi, Arena arena) {
