 ...
 * }
 */
public class PFNGLUNIFORM3IVARBPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLUNIFORM3IVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLUNIFORM3IVARBPROC.Function fi, Arena arena) {
