 ...
 * }
 */
public class PFNGLGETMULTITEXPARAMETERIUIVEXTPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLGETMULTITEXPARAMETERIUIVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETMULTITEXPARAMETERIUIVEXTPROC.Function fi, Arena arena) {
