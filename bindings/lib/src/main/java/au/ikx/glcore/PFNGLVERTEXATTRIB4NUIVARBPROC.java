 ...
 * }
 */
public class PFNGLVERTEXATTRIB4NUIVARBPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLVERTEXATTRIB4NUIVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIB4NUIVARBPROC.Function fi, Arena arena) {
