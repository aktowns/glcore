...
public class PFNGLCOLOR3SPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLCOLOR3SPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLCOLOR3SPROC.Function fi, Arena arena) {
