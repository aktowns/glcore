 ...
 * }
 */
public class PFNGLTEXPARAMETERIUIVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLTEXPARAMETERIUIVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLTEXPARAMETERIUIVPROC.Function fi, Arena arena) {
