 ...
 * }
 */
public class PFNGLGETBUFFERPOINTERVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLGETBUFFERPOINTERVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETBUFFERPOINTERVPROC.Function fi, Arena arena) {
