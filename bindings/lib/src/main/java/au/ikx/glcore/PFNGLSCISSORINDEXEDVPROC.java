 ...
 * }
 */
public class PFNGLSCISSORINDEXEDVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLSCISSORINDEXEDVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLSCISSORINDEXEDVPROC.Function fi, Arena arena) {
