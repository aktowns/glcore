 ...
 * }
 */
public class PFNGLNAMEDBUFFERSUBDATAPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLNAMEDBUFFERSUBDATAPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLNAMEDBUFFERSUBDATAPROC.Function fi, Arena arena) {
