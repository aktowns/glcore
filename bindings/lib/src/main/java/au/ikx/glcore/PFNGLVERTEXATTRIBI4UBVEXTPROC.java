 ...
 * }
 */
public class PFNGLVERTEXATTRIBI4UBVEXTPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLVERTEXATTRIBI4UBVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIBI4UBVEXTPROC.Function fi, Arena arena) {
