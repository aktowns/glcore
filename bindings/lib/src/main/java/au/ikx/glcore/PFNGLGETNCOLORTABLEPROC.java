 ...
 * }
 */
public class PFNGLGETNCOLORTABLEPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLGETNCOLORTABLEPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETNCOLORTABLEPROC.Function fi, Arena arena) {
