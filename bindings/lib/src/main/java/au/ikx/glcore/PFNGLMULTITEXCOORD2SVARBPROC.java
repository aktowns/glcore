 ...
 * }
 */
public class PFNGLMULTITEXCOORD2SVARBPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLMULTITEXCOORD2SVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLMULTITEXCOORD2SVARBPROC.Function fi, Arena arena) {
