 ...
 * }
 */
public class PFNGLPROGRAMUNIFORMMATRIX3DVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLPROGRAMUNIFORMMATRIX3DVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORMMATRIX3DVPROC.Function fi, Arena arena) {
