 ...
 * }
 */
public class PFNGLUNIFORMMATRIX3X2FVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLUNIFORMMATRIX3X2FVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLUNIFORMMATRIX3X2FVPROC.Function fi, Arena arena) {
