 ...
 * }
 */
public class PFNGLWINDOWPOS4DMESAPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLWINDOWPOS4DMESAPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLWINDOWPOS4DMESAPROC.Function fi, Arena arena) {
