 ...
 * }
 */
public class PFNGLNAMEDFRAMEBUFFERTEXTURELAYERPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLNAMEDFRAMEBUFFERTEXTURELAYERPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLNAMEDFRAMEBUFFERTEXTURELAYERPROC.Function fi, Arena arena) {
