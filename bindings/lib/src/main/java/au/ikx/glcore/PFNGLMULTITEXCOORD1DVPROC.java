 ...
 * }
 */
public class PFNGLMULTITEXCOORD1DVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLMULTITEXCOORD1DVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLMULTITEXCOORD1DVPROC.Function fi, Arena arena) {
