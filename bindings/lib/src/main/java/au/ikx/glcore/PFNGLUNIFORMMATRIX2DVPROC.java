 ...
 * }
 */
public class PFNGLUNIFORMMATRIX2DVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLUNIFORMMATRIX2DVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLUNIFORMMATRIX2DVPROC.Function fi, Arena arena) {
