 ...
 * }
 */
public class PFNGLPROGRAMUNIFORMMATRIX4X3DVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLPROGRAMUNIFORMMATRIX4X3DVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORMMATRIX4X3DVPROC.Function fi, Arena arena) {
