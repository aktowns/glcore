 ...
 * }
 */
public class PFNGLVERTEXATTRIBI4IVEXTPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLVERTEXATTRIBI4IVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIBI4IVEXTPROC.Function fi, Arena arena) {
