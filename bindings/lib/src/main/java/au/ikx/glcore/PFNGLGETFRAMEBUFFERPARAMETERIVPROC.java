 ...
 * }
 */
public class PFNGLGETFRAMEBUFFERPARAMETERIVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLGETFRAMEBUFFERPARAMETERIVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETFRAMEBUFFERPARAMETERIVPROC.Function fi, Arena arena) {
