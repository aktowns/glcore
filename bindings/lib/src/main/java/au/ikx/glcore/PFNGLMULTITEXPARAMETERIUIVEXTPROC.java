 ...
 * }
 */
public class PFNGLMULTITEXPARAMETERIUIVEXTPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLMULTITEXPARAMETERIUIVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLMULTITEXPARAMETERIUIVEXTPROC.Function fi, Arena arena) {
