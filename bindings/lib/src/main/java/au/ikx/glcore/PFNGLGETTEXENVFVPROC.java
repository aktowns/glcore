 ...
 * }
 */
public class PFNGLGETTEXENVFVPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLGETTEXENVFVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETTEXENVFVPROC.Function fi, Arena arena) {
