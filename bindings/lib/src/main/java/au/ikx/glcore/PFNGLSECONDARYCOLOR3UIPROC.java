 ...
 * }
 */
public class PFNGLSECONDARYCOLOR3UIPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLSECONDARYCOLOR3UIPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLSECONDARYCOLOR3UIPROC.Function fi, Arena arena) {
