 ...
 * }
 */
public class PFNGLGETBUFFERPARAMETERIVARBPROC {
    ...
    private static final MethodHandle UP$MH = glcore.upcallHandle(PFNGLGETBUFFERPARAMETERIVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETBUFFERPARAMETERIVARBPROC.Function fi, Arena arena) {
