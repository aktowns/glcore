...
public class PFNGLRECTSVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLRECTSVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLRECTSVPROC.Function fi, Arena arena) {
