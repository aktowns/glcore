 ...
 * }
 */
public class pRENDERDOC_GetCaptureOptionU32 {
    ...
    private static final MethodHandle UP$MH = RenderDoc.upcallHandle(pRENDERDOC_GetCaptureOptionU32.Function.class, "apply", $DESC);
