 ...
 * }
 */
public class PFNGLVERTEXATTRIB4NUBVARBPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLVERTEXATTRIB4NUBVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIB4NUBVARBPROC.Function fi, Arena arena) {
