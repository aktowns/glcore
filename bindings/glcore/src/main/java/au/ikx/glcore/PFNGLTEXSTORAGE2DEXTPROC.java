 ...
 * }
 */
public class PFNGLTEXSTORAGE2DEXTPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLTEXSTORAGE2DEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLTEXSTORAGE2DEXTPROC.Function fi, Arena arena) {
