 ...
 * }
 */
public class PFNGLUNIFORM1IVARBPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLUNIFORM1IVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLUNIFORM1IVARBPROC.Function fi, Arena arena) {
