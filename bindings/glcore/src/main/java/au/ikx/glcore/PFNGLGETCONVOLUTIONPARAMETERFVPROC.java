 ...
 * }
 */
public class PFNGLGETCONVOLUTIONPARAMETERFVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLGETCONVOLUTIONPARAMETERFVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETCONVOLUTIONPARAMETERFVPROC.Function fi, Arena arena) {
