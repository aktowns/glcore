 ...
 * }
 */
public class PFNGLMAPNAMEDBUFFERRANGEPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLMAPNAMEDBUFFERRANGEPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLMAPNAMEDBUFFERRANGEPROC.Function fi, Arena arena) {
