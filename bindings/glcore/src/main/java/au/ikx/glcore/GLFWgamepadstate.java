...
public class GLFWgamepadstate {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(15, GLCore.C_CHAR).withName("buttons"),
        MemoryLayout.paddingLayout(1),
        MemoryLayout.sequenceLayout(6, GLCore.C_FLOAT).withName("axes")
    ...
    private static final long buttons$OFFSET = 0;
    ...
    public static byte buttons(MemorySegment struct, long index0) {
        return (byte)buttons$ELEM_HANDLE.get(struct, 0L, index0);
    }
    ...
    private static final long axes$OFFSET = 16;
    ...
    public static float axes(MemorySegment struct, long index0) {
        return (float)axes$ELEM_HANDLE.get(struct, 0L, index0);
    }
