...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        STBImage.C_INT.withName("__readers"),
        STBImage.C_INT.withName("__writers"),
        STBImage.C_INT.withName("__wrphase_futex"),
        STBImage.C_INT.withName("__writers_futex"),
        STBImage.C_INT.withName("__pad3"),
        STBImage.C_INT.withName("__pad4"),
        STBImage.C_INT.withName("__cur_writer"),
        STBImage.C_INT.withName("__shared"),
        STBImage.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, STBImage.C_CHAR).withName("__pad1"),
        STBImage.C_LONG.withName("__pad2"),
        STBImage.C_INT.withName("__flags"),
