 ...
 * }
 */
public class PFNGLVERTEXATTRIB4NUBVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLVERTEXATTRIB4NUBVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIB4NUBVPROC.Function fi, Arena arena) {
