 ...
 * }
 */
public class PFNGLPROGRAMPARAMETER4DVNVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLPROGRAMPARAMETER4DVNVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMPARAMETER4DVNVPROC.Function fi, Arena arena) {
