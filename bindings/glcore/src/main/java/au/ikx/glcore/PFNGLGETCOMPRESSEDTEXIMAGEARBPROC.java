 ...
 * }
 */
public class PFNGLGETCOMPRESSEDTEXIMAGEARBPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLGETCOMPRESSEDTEXIMAGEARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETCOMPRESSEDTEXIMAGEARBPROC.Function fi, Arena arena) {
