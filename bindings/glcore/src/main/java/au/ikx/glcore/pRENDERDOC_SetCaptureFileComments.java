...
public class pRENDERDOC_SetCaptureFileComments {
    ...
    public interface Function {
        void apply(MemorySegment filePath, MemorySegment comments);
    }
    ...
    private static final MethodHandle UP$MH = RenderDoc.upcallHandle(pRENDERDOC_SetCaptureFileComments.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(pRENDERDOC_SetCaptureFileComments.Function fi, Arena arena) {
