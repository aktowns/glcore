 ...
 * }
 */
public class PFNGLVERTEXATTRIB4UIVARBPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLVERTEXATTRIB4UIVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIB4UIVARBPROC.Function fi, Arena arena) {
