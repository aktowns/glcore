 ...
 * }
 */
public class PFNGLPROGRAMUNIFORM4FVEXTPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLPROGRAMUNIFORM4FVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORM4FVEXTPROC.Function fi, Arena arena) {
