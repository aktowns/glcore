 ...
 * }
 */
public class PFNGLTEXPARAMETERIIVEXTPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLTEXPARAMETERIIVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLTEXPARAMETERIIVEXTPROC.Function fi, Arena arena) {
