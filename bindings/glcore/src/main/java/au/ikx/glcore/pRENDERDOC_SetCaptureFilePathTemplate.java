...
public class pRENDERDOC_SetCaptureFilePathTemplate {
    ...
    public interface Function {
        void apply(MemorySegment pathtemplate);
    }
    ...
    private static final MethodHandle UP$MH = RenderDoc.upcallHandle(pRENDERDOC_SetCaptureFilePathTemplate.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(pRENDERDOC_SetCaptureFilePathTemplate.Function fi, Arena arena) {
