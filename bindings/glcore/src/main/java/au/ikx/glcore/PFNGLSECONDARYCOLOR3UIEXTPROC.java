 ...
 * }
 */
public class PFNGLSECONDARYCOLOR3UIEXTPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLSECONDARYCOLOR3UIEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLSECONDARYCOLOR3UIEXTPROC.Function fi, Arena arena) {
