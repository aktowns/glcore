...
public class _IO_FILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        STBImage.C_INT.withName("_flags"),
        MemoryLayout.paddingLayout(4),
        STBImage.C_POINTER.withName("_IO_read_ptr"),
        STBImage.C_POINTER.withName("_IO_read_end"),
        STBImage.C_POINTER.withName("_IO_read_base"),
        STBImage.C_POINTER.withName("_IO_write_base"),
        STBImage.C_POINTER.withName("_IO_write_ptr"),
        STBImage.C_POINTER.withName("_IO_write_end"),
        STBImage.C_POINTER.withName("_IO_buf_base"),
        STBImage.C_POINTER.withName("_IO_buf_end"),
        STBImage.C_POINTER.withName("_IO_save_base"),
        STBImage.C_POINTER.withName("_IO_backup_base"),
        STBImage.C_POINTER.withName("_IO_save_end"),
        STBImage.C_POINTER.withName("_markers"),
        STBImage.C_POINTER.withName("_chain"),
        STBImage.C_INT.withName("_fileno"),
        STBImage.C_INT.withName("_flags2"),
        STBImage.C_LONG.withName("_old_offset"),
        STBImage.C_SHORT.withName("_cur_column"),
        STBImage.C_CHAR.withName("_vtable_offset"),
        MemoryLayout.sequenceLayout(1, STBImage.C_CHAR).withName("_shortbuf"),
        MemoryLayout.paddingLayout(4),
        STBImage.C_POINTER.withName("_lock"),
        STBImage.C_LONG.withName("_offset"),
        STBImage.C_POINTER.withName("_codecvt"),
        STBImage.C_POINTER.withName("_wide_data"),
        STBImage.C_POINTER.withName("_freeres_list"),
        STBImage.C_POINTER.withName("_freeres_buf"),
        STBImage.C_LONG.withName("__pad5"),
        STBImage.C_INT.withName("_mode"),
        MemoryLayout.sequenceLayout(20, STBImage.C_CHAR).withName("_unused2")
    ).withName("_IO_FILE");
