 ...
 * }
 */
public class pRENDERDOC_TriggerMultiFrameCapture {
    ...
    private static final MethodHandle UP$MH = RenderDoc.upcallHandle(pRENDERDOC_TriggerMultiFrameCapture.Function.class, "apply", $DESC);
