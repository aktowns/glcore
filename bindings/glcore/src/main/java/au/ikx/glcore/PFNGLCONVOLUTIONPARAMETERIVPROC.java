 ...
 * }
 */
public class PFNGLCONVOLUTIONPARAMETERIVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLCONVOLUTIONPARAMETERIVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLCONVOLUTIONPARAMETERIVPROC.Function fi, Arena arena) {
