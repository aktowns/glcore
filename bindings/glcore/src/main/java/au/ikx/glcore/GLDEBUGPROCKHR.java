...
/**
 * {@snippet lang=c :
 * typedef void (*GLDEBUGPROCKHR)(GLenum, GLenum, GLuint, GLenum, GLsizei, const GLchar *, const void *)
 * }
 */
public class GLDEBUGPROCKHR {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(GLDEBUGPROCKHR.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GLDEBUGPROCKHR.Function fi, Arena arena) {
