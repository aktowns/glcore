 ...
 * }
 */
public class PFNGLSECONDARYCOLOR3BPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLSECONDARYCOLOR3BPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLSECONDARYCOLOR3BPROC.Function fi, Arena arena) {
