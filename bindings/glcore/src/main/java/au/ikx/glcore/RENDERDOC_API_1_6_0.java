...
public class RENDERDOC_API_1_6_0 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        RenderDoc.C_POINTER.withName("GetAPIVersion"),
        RenderDoc.C_POINTER.withName("SetCaptureOptionU32"),
        RenderDoc.C_POINTER.withName("SetCaptureOptionF32"),
        RenderDoc.C_POINTER.withName("GetCaptureOptionU32"),
        RenderDoc.C_POINTER.withName("GetCaptureOptionF32"),
        RenderDoc.C_POINTER.withName("SetFocusToggleKeys"),
        RenderDoc.C_POINTER.withName("SetCaptureKeys"),
        RenderDoc.C_POINTER.withName("GetOverlayBits"),
        RenderDoc.C_POINTER.withName("MaskOverlayBits"),
        MemoryLayout.unionLayout(
            RenderDoc.C_POINTER.withName("Shutdown"),
            RenderDoc.C_POINTER.withName("RemoveHooks")
        ).withName("$anon$640:3"),
        RenderDoc.C_POINTER.withName("UnloadCrashHandler"),
        MemoryLayout.unionLayout(
            RenderDoc.C_POINTER.withName("SetLogFilePathTemplate"),
            RenderDoc.C_POINTER.withName("SetCaptureFilePathTemplate")
        ).withName("$anon$649:3"),
        MemoryLayout.unionLayout(
            RenderDoc.C_POINTER.withName("GetLogFilePathTemplate"),
            RenderDoc.C_POINTER.withName("GetCaptureFilePathTemplate")
        ).withName("$anon$656:3"),
        RenderDoc.C_POINTER.withName("GetNumCaptures"),
        RenderDoc.C_POINTER.withName("GetCapture"),
        RenderDoc.C_POINTER.withName("TriggerCapture"),
        MemoryLayout.unionLayout(
            RenderDoc.C_POINTER.withName("IsRemoteAccessConnected"),
            RenderDoc.C_POINTER.withName("IsTargetControlConnected")
        ).withName("$anon$671:3"),
        RenderDoc.C_POINTER.withName("LaunchReplayUI"),
        RenderDoc.C_POINTER.withName("SetActiveWindow"),
        RenderDoc.C_POINTER.withName("StartFrameCapture"),
        RenderDoc.C_POINTER.withName("IsFrameCapturing"),
        RenderDoc.C_POINTER.withName("EndFrameCapture"),
        RenderDoc.C_POINTER.withName("TriggerMultiFrameCapture"),
        RenderDoc.C_POINTER.withName("SetCaptureFileComments"),
        RenderDoc.C_POINTER.withName("DiscardFrameCapture"),
        RenderDoc.C_POINTER.withName("ShowReplayUI"),
        RenderDoc.C_POINTER.withName("SetCaptureTitle")
