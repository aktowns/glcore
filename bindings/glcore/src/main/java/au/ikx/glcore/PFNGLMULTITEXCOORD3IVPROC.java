 ...
 * }
 */
public class PFNGLMULTITEXCOORD3IVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLMULTITEXCOORD3IVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLMULTITEXCOORD3IVPROC.Function fi, Arena arena) {
