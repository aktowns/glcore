 ...
 * }
 */
public class PFNGLMULTITEXCOORD1DVARBPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLMULTITEXCOORD1DVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLMULTITEXCOORD1DVARBPROC.Function fi, Arena arena) {
