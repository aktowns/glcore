 ...
 * }
 */
public class PFNGLSAMPLECOVERAGEARBPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLSAMPLECOVERAGEARBPROC.Function.class, "apply", $DESC);
