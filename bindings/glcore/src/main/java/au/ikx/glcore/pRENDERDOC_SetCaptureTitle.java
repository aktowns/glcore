...
public class pRENDERDOC_SetCaptureTitle {
    ...
    public interface Function {
        void apply(MemorySegment title);
    }
    ...
    private static final MethodHandle UP$MH = RenderDoc.upcallHandle(pRENDERDOC_SetCaptureTitle.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(pRENDERDOC_SetCaptureTitle.Function fi, Arena arena) {
