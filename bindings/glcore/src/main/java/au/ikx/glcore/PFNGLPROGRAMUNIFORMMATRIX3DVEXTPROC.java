 ...
 * }
 */
public class PFNGLPROGRAMUNIFORMMATRIX3DVEXTPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLPROGRAMUNIFORMMATRIX3DVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORMMATRIX3DVEXTPROC.Function fi, Arena arena) {
