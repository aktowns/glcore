 ...
 * }
 */
public class PFNGLGETDEBUGMESSAGELOGPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLGETDEBUGMESSAGELOGPROC.Function.class, "apply", $DESC);
