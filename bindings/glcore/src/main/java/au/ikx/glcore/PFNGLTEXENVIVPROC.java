 ...
 * }
 */
public class PFNGLTEXENVIVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLTEXENVIVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLTEXENVIVPROC.Function fi, Arena arena) {
