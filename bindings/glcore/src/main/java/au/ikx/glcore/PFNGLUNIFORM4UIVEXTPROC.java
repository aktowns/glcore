 ...
 * }
 */
public class PFNGLUNIFORM4UIVEXTPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLUNIFORM4UIVEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLUNIFORM4UIVEXTPROC.Function fi, Arena arena) {
