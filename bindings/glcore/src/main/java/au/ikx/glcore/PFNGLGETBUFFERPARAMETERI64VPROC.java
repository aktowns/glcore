 ...
 * }
 */
public class PFNGLGETBUFFERPARAMETERI64VPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLGETBUFFERPARAMETERI64VPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETBUFFERPARAMETERI64VPROC.Function fi, Arena arena) {
