 ...
 * }
 */
public class PFNGLUNIFORMMATRIX3FVARBPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLUNIFORMMATRIX3FVARBPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLUNIFORMMATRIX3FVARBPROC.Function fi, Arena arena) {
