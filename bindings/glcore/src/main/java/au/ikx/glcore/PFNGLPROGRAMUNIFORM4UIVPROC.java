 ...
 * }
 */
public class PFNGLPROGRAMUNIFORM4UIVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLPROGRAMUNIFORM4UIVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORM4UIVPROC.Function fi, Arena arena) {
