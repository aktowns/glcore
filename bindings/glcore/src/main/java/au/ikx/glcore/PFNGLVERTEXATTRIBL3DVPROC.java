 ...
 * }
 */
public class PFNGLVERTEXATTRIBL3DVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLVERTEXATTRIBL3DVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLVERTEXATTRIBL3DVPROC.Function fi, Arena arena) {
