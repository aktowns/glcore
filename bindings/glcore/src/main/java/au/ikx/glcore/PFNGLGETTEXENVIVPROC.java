 ...
 * }
 */
public class PFNGLGETTEXENVIVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLGETTEXENVIVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLGETTEXENVIVPROC.Function fi, Arena arena) {
