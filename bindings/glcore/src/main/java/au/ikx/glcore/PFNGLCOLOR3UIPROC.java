 ...
 * }
 */
public class PFNGLCOLOR3UIPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLCOLOR3UIPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLCOLOR3UIPROC.Function fi, Arena arena) {
