 ...
 * }
 */
public class PFNGLSECONDARYCOLOR3UBEXTPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLSECONDARYCOLOR3UBEXTPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLSECONDARYCOLOR3UBEXTPROC.Function fi, Arena arena) {
