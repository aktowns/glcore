...
public class pRENDERDOC_SetCaptureKeys {
    ...
    private static final MethodHandle UP$MH = RenderDoc.upcallHandle(pRENDERDOC_SetCaptureKeys.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(pRENDERDOC_SetCaptureKeys.Function fi, Arena arena) {
