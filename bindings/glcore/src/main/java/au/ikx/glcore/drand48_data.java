...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, STBImage.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, STBImage.C_SHORT).withName("__old_x"),
        STBImage.C_SHORT.withName("__c"),
        STBImage.C_SHORT.withName("__init"),
        STBImage.C_LONG_LONG.withName("__a")
