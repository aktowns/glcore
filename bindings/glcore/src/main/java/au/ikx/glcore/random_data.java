...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        STBImage.C_POINTER.withName("fptr"),
        STBImage.C_POINTER.withName("rptr"),
        STBImage.C_POINTER.withName("state"),
        STBImage.C_INT.withName("rand_type"),
        STBImage.C_INT.withName("rand_deg"),
        STBImage.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        STBImage.C_POINTER.withName("end_ptr")
