...
/**
 * {@snippet lang=c :
 * typedef void (*PFNGLSEPARABLEFILTER2DPROC)(GLenum, GLenum, GLsizei, GLsizei, GLenum, GLenum, const void *, const void *)
 * }
 */
public class PFNGLSEPARABLEFILTER2DPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLSEPARABLEFILTER2DPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLSEPARABLEFILTER2DPROC.Function fi, Arena arena) {
