...
/**
 * {@snippet lang=c :
 * typedef void (*PFNGLGETCOMPRESSEDTEXIMAGEPROC)(GLenum, GLint, void *)
 * }
 */
public class PFNGLGETCOMPRESSEDTEXIMAGEPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLGETCOMPRESSEDTEXIMAGEPROC.Function.class, "apply", $DESC);
