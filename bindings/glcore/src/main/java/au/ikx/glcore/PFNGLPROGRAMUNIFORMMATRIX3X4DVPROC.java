 ...
 * }
 */
public class PFNGLPROGRAMUNIFORMMATRIX3X4DVPROC {
    ...
    private static final MethodHandle UP$MH = GLCore.upcallHandle(PFNGLPROGRAMUNIFORMMATRIX3X4DVPROC.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PFNGLPROGRAMUNIFORMMATRIX3X4DVPROC.Function fi, Arena arena) {
